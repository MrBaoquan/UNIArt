...
namespace UNIArt.Editor
{
    ...
    public struct SVNStatusData
    {
        ...
        public bool IsMovedFile =>
            !string.IsNullOrEmpty(MovedTo) || !string.IsNullOrEmpty(MovedFrom);
    ...
    public struct LockDetails
    {
        ...
        public bool IsValid =>
            !string.IsNullOrEmpty(Path) && OperationResult == StatusOperationResult.Success;

        public static LockDetails Empty =>
            new LockDetails()
            {
                Path = string.Empty,
                Owner = string.Empty,
                ...
                Date = string.Empty,
                OperationResult = StatusOperationResult.Success
            };
    ...
    {
        [Tooltip(
            "Target folder to monitor for lock prompt, relative to the project.\n\nExample: \"Assets/Scenes\""
        )]
...
#endif
        [Tooltip(
            "Relative path (contains '/') or asset name to be ignored in the Target Folder.\n\nExample: \"Assets/Scenes/Baked\" or \"_deprecated\""
        )]
    ...
    public struct BranchScanParameters
    {
        ...
        public bool IsValid =>
            !string.IsNullOrEmpty(EntryPointURL) && BranchSignatureRootEntries.Length > 0;
