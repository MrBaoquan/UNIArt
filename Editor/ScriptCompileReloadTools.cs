...
namespace UNIHper.Art.Editor
{
    public class ScriptCompileReloadTools
    {
         ...
         */
        // manual reload domain
        // auto reload domain
        const string menuEnableManualReload = "UNIHper/Workflow/Manual Reload Domain";
        const string menuDisenableManualReload = "UNIHper/Workflow/Auto Reload Domain";
        const string menuReloadDomain = "UNIHper/Workflow/Reload Domain %t";
        ...
        private static void OnAfterAssemblyReload()
        {
            if (IsManualReload)
            {
                ...
                Debug.Log($"<color=yellow>Reload domain finished, took {timeMS} ms</color>");
                LockReloadDomain();
            }
        }
