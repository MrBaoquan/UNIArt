...
namespace R2D
{
    ...
    public class R2DD_Resources
    {
        ...
        string r2dResourcesPath = "Packages/com.parful.uniart/Editor/R2D/R2DResources/";
        ...
        private R2DD_Resources()
        {
            ...
            // r2dResourcesPath =
            //     dirs[0].Replace(Environment.CurrentDirectory + Path.DirectorySeparatorChar, "")
        ...
        {
            return AssetDatabase.LoadAssetAtPath(r2dResourcesPath + textureName, typeof(Texture2D))
                as Texture2D;
        }

        Texture LoadTexture(string textureName)
        {
            return AssetDatabase.LoadAssetAtPath(r2dResourcesPath + textureName, typeof(Texture))
                as Texture;
        }
        ...
        {
            return AssetDatabase.LoadAssetAtPath(r2dResourcesPath + spriteName, typeof(Sprite))
                as Sprite;
        }
        ...
        public const string urlSettingsHelp =
            "http://pixelfire.co/ruler-2d-guides-grid-and-alignment-tools-for-unity/#settings";
        public const string urlGridHelp =
            "http://pixelfire.co/ruler-2d-guides-grid-and-alignment-tools-for-unity/#grid";
        public const string urlToolboxHelp =
            "http://pixelfire.co/ruler-2d-guides-grid-and-alignment-tools-for-unity/#toolbox";
    }
}
