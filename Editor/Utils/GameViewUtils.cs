...
// /// Added preferences window with quick select and bulk add by Fábio Damian (@Biodam)
// /// </summary>
// [InitializeOnLoad]
...
//         var selectedSizeIndexProp = gvWndType.GetProperty(
//             "selectedSizeIndex",
...
//             new Type[] { gvstType, typeof(int), typeof(int), typeof(string) }
//         );
...
//     {
//         var gvWndType = typeof(Editor).Assembly.GetType("UnityEditor.GameView");
//         var updateZoomAreaAndParentMethod = gvWndType.GetMethod(
...
//         int sizesCount =
//             (int)getBuiltinCount.Invoke(group, null) + (int)getCustomCount.Invoke(group, null);
...
//     {
//         var getCurrentGroupTypeProp = gameViewSizesInstance
//             .GetType()
//             .GetProperty("currentGroupType");
//         return (GameViewSizeGroupType)
//             (int)getCurrentGroupTypeProp.GetValue(gameViewSizesInstance, null);
//     }
...
//         if (
//             customGameViewCollection != null
//             && customGameViewCollectionSO != null
//             && customGamViewSizesRL != null
//         )
//         {
...
//             "This button will create all the custom sizes on all the group types.",
//             MessageType.Info,
//             true
//         );
...
//             Debug.Log(
//                 "Added custom sizes. Because of Unity internal serializations it may be needed for you to manually add one custom size (you can delete it right away) to force Unity to save the custom sizes. If you don't do this, when opening Unity again all the sizes may be gone."
//             );
...
//         EditorGUILayout.HelpBox(
//             "Use quick select with alt+(1/2/3) it will select the game size of the index configured here.",
//             MessageType.Info,
//             true
//         );
...
//     {
//         customGamViewSizesRL = new ReorderableList(
//             customGameViewCollectionSO,
//             customGameViewSizesSP
//         );
...
//         customGamViewSizesRL.elementHeight =
//             (EditorGUIUtility.singleLineHeight * 3) + (EditorGUIUtility.singleLineHeight / 2);

//         customGamViewSizesRL.drawElementCallback = (
//             Rect rect,
//             int index,
//             bool isActive,
//             bool isFocused
...
//                 rectSingleLineHeight,
//                 current.FindPropertyRelative("width"),
//                 GUIContent.none
//             );
//             rectSingleLineHeight.x += fractionWidth;
...
//             EditorGUI.PropertyField(
//                 rectSingleLineHeight,
//                 current.FindPropertyRelative("height"),
//                 GUIContent.none
//             );
